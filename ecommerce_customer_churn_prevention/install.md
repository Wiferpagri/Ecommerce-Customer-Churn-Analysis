# Ecommerce Customer Churn prevention guide installation
...
activate ecommerce_customer_churn_prevention
```
...
To move beyond notebook prototyping, all reusable code should go into the `ecommerce_customer_churn_prevention/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `ecommerce_customer_churn_prevention` folder and use the modules inside your notebooks :
...
```python
from ecommerce_customer_churn_prevention.utils.paths import data_dir
data_dir()
```
